...
import { ProductLabel } from "@pixa/ui/shared/product-label";
import { ProductsDropdown } from "@pixa/ui/shared/products-dropdown";
...
export function SiteHeader({
  ...
  return (
    <header className="fixed top-0 z-40 w-full bg-sidebar/80 backdrop-blur-sm before:absolute before:inset-x-0 before:bottom-0 before:h-px before:bg-border/64">
