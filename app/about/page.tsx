  ...
  return (
    <>
      <div className="flex h-screen w-full flex-col items-center justify-between text-center">
        <Nav />
        <div className="md:px-38 lg:px-40 flex h-screen w-full max-w-[45rem] flex-col items-start justify-start px-8 xs:px-4">
          <div className="flex flex-col items-start justify-start">
            <h1 className="mt-8 text-center text-[48px] font-[600] text-[var(--foreground)]">
              About
            </h1>
            <p className="text-left text-lg text-[var(--text-secondary)]">
              Pixa UI is a curated collection of versatile{" "}
              <Badge color="pink">&nbsp;React.js/Next.js&nbsp;</Badge>
              components
            </p>
            <br />
            <p className="text-left text-lg text-[var(--text-secondary)]">
            ...
            <br />
            <p className="text-left text-lg text-[var(--text-secondary)]">
              Pixa UI is <Badge>&nbsp;open source&nbsp;</Badge> and available
            ...
            <div className="my-4 w-full border-b border-[var(--border)]"></div>
            <div className="flex w-full justify-between">
              ...
              <div className="social flex gap-2">
                <Link href={LINK.TWITTER} target="_blank">
                  ...
                  >
                    <path
                      d="M17.73 3H20.7835L14.1124 10.6246L21.9604 21H15.8155L11.0026 14.7074L5.49549 21H2.44011L9.57549 12.8446L2.04688 3H8.3478L12.6983 8.75169L17.73 3ZM16.6583 19.1723H18.3503L7.42841 4.73169H5.61272L16.6583 19.1723Z"
                      fill="currentColor"
                    />
                  </svg>
                </Link>
