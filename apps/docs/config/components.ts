...
export const componentCategories: ComponentCategory[] = [
  ...
  },
  {
    id: "extra",
    name: "Others",
    description: "Notification bell with unique animations and styles",
    components: [
      {
        id: "notification-bell",
        name: "Notification Bell",
        description:
          "Stylish notification bell with animated notifications and sound effects",
        component: NotificationBell,
        code: `// TODO: Add actual notification bell component code`,
        props: [],
        dependencies: [],
        examples: [],
      },
