...
<Card variant="shine">
	<div className="flex flex-col gap-2">
		<span className="text-xl font-semibold text-neutral-100 dark:text-neutral-200">Pixa</span>
...
<Card variant="animated-border">
	<div className="flex flex-col gap-2">
		<span className="text-xl font-semibold text-black dark:text-neutral-200">Pixa</span>
...
<CommandBlock 
	npmCommand="npx @pixaui/ui@beta add card" 
	pnpmCommand="pnpm dlx @pixaui/ui@beta add card" 
	yarnCommand="npx @pixaui/ui@beta add card" 
	bunCommand="bunx --bun @pixaui/ui@beta add card" 
/>
