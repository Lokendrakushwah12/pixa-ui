...
<CommandBlock 
	npmCommand="npx @pixaui/ui@beta add badge" 
	pnpmCommand="pnpm dlx @pixaui/ui@beta add badge" 
	yarnCommand="npx @pixaui/ui@beta add badge" 
	bunCommand="bunx --bun @pixaui/ui@beta add badge" 
/>
