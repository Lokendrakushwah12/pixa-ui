...
<CommandBlock 
	npmCommand="npx @pixaui/ui@beta add switch" 
	pnpmCommand="pnpm dlx @pixaui/ui@beta add switch" 
	yarnCommand="npx @pixaui/ui@beta add switch" 
	bunCommand="bunx --bun @pixaui/ui@beta add switch" 
/>
