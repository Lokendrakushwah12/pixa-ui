...
<CommandBlock 
	npmCommand="npx @pixaui/ui@beta add button" 
	pnpmCommand="pnpm dlx @pixaui/ui@beta add button" 
	yarnCommand="npx @pixaui/ui@beta add button" 
	bunCommand="bunx --bun @pixaui/ui@beta add button" 
/>
