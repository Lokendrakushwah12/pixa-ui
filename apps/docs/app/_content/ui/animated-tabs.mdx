...
<CommandBlock 
	npmCommand="npx @pixaui/ui@beta add animated-tabs" 
	pnpmCommand="pnpm dlx @pixaui/ui@beta add animated-tabs" 
	yarnCommand="npx @pixaui/ui@beta add animated-tabs" 
	bunCommand="bunx --bun @pixaui/ui@beta add animated-tabs" 
/>
