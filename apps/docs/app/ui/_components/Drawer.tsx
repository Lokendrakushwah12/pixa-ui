...
export default function Drawer({ children }: { children: React.ReactNode }) {
  ...
  return (
    <VaulDrawer.Root open={isOpen} onOpenChange={setIsOpen} direction="left">
      ...
      <VaulDrawer.Portal>
        ...
        <VaulDrawer.Content
          ...
          className="fixed top-2 left-2 bottom-2 z-[70] flex w-[270px] bg-background rounded-2xl border outline-none"
          style={
        ...
        >
          ...
          <div className="relative flex h-full w-full grow flex-col rounded-[16px] bg-drawer px-3 pb-5">
            <div className="flex items-center justify-between gap-2 px-2 py-3">
              <a
                href="https://github.com/lokendra/pixa"
                target="_blank"
                rel="noopener noreferrer"
                className="group"
              >
                <GithubIcon className="group-hover:!text-primary size-4 text-neutral-400 duration-150 dark:text-neutral-600" />
              </a>
              <ThemeToggle />
            </div>
