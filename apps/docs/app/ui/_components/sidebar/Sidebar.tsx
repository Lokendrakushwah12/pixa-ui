...
export const getMDXdocs = getDocsMdx("ui").sort((a, b) =>
...
export function Sidebar() {
  ...
  return (
    <aside className="sticky w-full block shrink-0 top-16 max-md:hidden">
      <nav className="flex flex-col gap-6 overflow-y-auto py-8 px-6 noscrollbar">
        <ScrollArea className="h-[85vh] overflow-yauto">
          {categories.map((category) => (
            <div key={category} className="flex flex-col gap-1 ml-12">
