...
```bash
npx shadcn@latest add @pixa/empty
```
...
The API design of this component is modeled after [shadcn/ui's empty component](https://ui.shadcn.com/docs/components/empty) to ensure familiarity and consistency for developers already using shadcn. This standardization makes it easier to adopt **pixa ui** while maintaining API parity with the patterns developers already know and love.
