  ...
  return (
    <>
      ...
      >
        ...
        <div className='absolute top-4 left-4 flex justify-center items-center gap-1 text-[#ffffffd4]'><img className='w-5 h-5' src={logo} alt="" />Stalwart Group</div>
        ...
        <div className='absolute bottom-4 left-4 flex flex-col justify-center items-start w-full'>
