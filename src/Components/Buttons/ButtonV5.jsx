...
const ButtonV5 = ({
  ...
  return (
    <div
      className={`relative ${disabledStyles} overflow-hidden ${className} `}
    ...
    >
      ...
      >
        ...
        >
          <div className="absolute left-1/2 top-0 h-2 w-3/4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white opacity-100 blur-lg transition-all duration-300 group-hover:opacity-10"></div>
          <h3
