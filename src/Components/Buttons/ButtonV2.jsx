  ...
  return (
    ...
    >
      <div
        ...
        className="absolute z-10 left-1/2 -bottom-3/4 -translate-x-1/2 -translate-y-3 w-3 h-3 group-hover:w-[120%] group-hover:h-[180%] rounded-full transition-all duration-500"
      ></div>
      <h3
