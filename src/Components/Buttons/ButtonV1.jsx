...
const ButtonV1 = ({
    ...
    const borderColor = `rgba(${parseInt(color.slice(1, 3), 16)}, ${parseInt(color.slice(3, 5), 16)}, ${parseInt(color.slice(5, 7), 16)}, 0.15)`;
    ...
    return (
        <>
            <div
                ...
                style={{ borderRadius: borderRadius, border: border == false ? 'none' : '1px solid #e5e7eb', borderColor: borderColor }}
            >
                <svg
                    ...
                    <path d="M9.42999 4L15.5 10.07L9.42999 16.14" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="square" stroke-linejoin="round" />
                    <path d="M4 10.0699L15 10.0699" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="square" stroke-linejoin="round" />
                </svg>
                <h3
