...
const ButtonV3 = ({ title, borderRadius, color }) => {
    ...
    const starVariants1 = {
        hover: { scale: [1, 1.1, 1], transition: { duration: 1, repeat: Infinity, repeatType: 'reverse' } },
    };

    const starVariants2 = {
        hover: { scale: [1, 1.2, 1], transition: { duration: 1.15, delay: 0.15, repeat: Infinity, repeatType: 'reverse' } },
    };

    const starVariants3 = {
        hover: { scale: [1, 1.3, 1], transition: { duration: 1.3, delay: 0.3, repeat: Infinity, repeatType: 'reverse' } },
    };
        ...
        >
            ...
            >
                <div
                    ...
                    onMouseOver={e => e.currentTarget.style.boxShadow = 'inset 0px -2px 0px rgba(255,255,255, 0.1)'}
                    onMouseOut={e => e.currentTarget.style.boxShadow = 'inset 0 0 0 0 rgba(255,255,255, 0)'}
                >
                    <div
