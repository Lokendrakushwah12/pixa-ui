      ...
      <div className="h-16 flex justify-center items-center">
        ...
        >
          ...
          <div
            ...
            className="border z-30 group-hover:border-8 border-[#8787870d] bg-[#8787871a] transition-all duration-300"
          >
            <div
            ...
            >
              ...
              >
                <div className="absolute w-3/4 h-[30px] opacity-100 group-hover:opacity-25 bg-[#fff] rounded-full -translate-x-1/2 translate-y-1/2 left-1/2 bottom-0 blur-[14px] mix-blend-overlay"></div>
                ...
                <h3
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(to right, #a1a1a1, #515151)",
                  }}
                >
                  {title}
                </h3>
