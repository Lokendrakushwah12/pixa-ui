                        ...
                        <div className="md:w-1/2 flex flex-col md:flex-row h-full w-full gap-4">
                            ...
                            <div className="w-full px-4 md:px-0 h-full flex flex-col items-start justify-center gap-1">
                                ...
                                <div className='p-2 w-full h-full text-sm text-gray-900 border bg-white border-gray-200 overflow-y-scroll flex flex-col gap-2 justify-start items-center rounded-lg'>
                                    ...
                                    {selectedData.componentName === 'CardV3' && <div className="h-full"> <CardV3 title='Speed' featureName="Feature 01" icon={Stalwarts} color="#0f60ff" angle={5} description='Instant answers, Greater productivity.' shadow={true} /> </div>}
                                    {selectedData.componentName === 'CardV3' && <div className="h-full"> <CardV3 title='Speed' featureName="Feature 02" icon={Stalwarts} color="#03b333" angle={-5} randomness={80} description='Instant answers, Greater productivity.' shadow={true} /> </div>}
                                    {selectedData.componentName === 'CardV3' && <div className="h-full"> <CardV3 title='Speed' featureName="Feature 03" icon={Stalwarts} color="#df9fdf" angle={5} randomness={0} description='Instant answers, Greater productivity.' shadow={true} /> </div>}
