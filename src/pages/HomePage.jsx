        ...
        <>
            <div {...pointerProps} className="relative w-full h-1/2 overflow-hidden">
                <div className="absolute z-40 flex flex-col w-full items-center justify-center h-[300px]">
                    ...
                    <h2 className="text-lg text-[#414141] font-[400] text-center mt-2">A Collection of <span className='font-[500]'>Open Source</span> Components for <span className='border font-[500] rounded-[0.25rem] px-1 bg-[#dedede3f]'>React + TailwindCSS</span> for Your Project</h2>
                </div>
